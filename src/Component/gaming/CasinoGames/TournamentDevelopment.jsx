          ...
          <div className="row">
            <div className="cta-content ps-5 col-lg-6 d-flex align-items-center overflow-hidden">
              ...
              WE MAKE DREAMS <br> COME TO LIFE
                ...
                <h3 className=" mb-4 mt-4 txt-center-m">
                  Top Rated Tournament Game Developer
                </h3>
                <p
                  style={{ color: "white" }}
                  className=" fw-normal mb-4 txt-center-m"
                >
                  One of the top companies for developing Tournament games is MetaBlock. Our skilled group of Tournament game developers specializes in making games that are both easy to use and graphically appealing. We provide cutting-edge features that improve the overall play experience for fans of Tournament all over the world. Our mission is to provide players all around the world with an unmatched Tournament gaming experience that piques their curiosity and brings them delight.
                </p>
            ...
            <div className="col-lg-6 ps-0">
              <img
                ...
                src="./images/tournamentdevelopment.webp"
                alt='tournamentdevelopment'
              />
            </div>
          </div>
        </section>
          ...
          <div className="row">
            <div className="col-lg-6 ps-0">
              <img
                ...
                src="./images/tournamentdevelopment1.webp"
                alt='tournamentdevelopment1'
              />
            </div>
            <div className="cta-content ps-5 col-lg-6 d-flex align-items-center overflow-hidden">
                        ...
                        <div className="row align-items-center justify-content-center">
                            <div className="col-lg-6 col-12">
                                <div className="banner_sec">
                                    <h1 className="title">
                                        <span className="bnr_clr_title">Tournament Game </span>{" "}
                                        <br /> Development
                                    </h1>
                                    <p className="contents">
                                        MetaBlock is a leading Tournament Game development company. Our experienced team of Tournament game developers specialized in creating visually captivating and user-friendly Tournament games. We incorporate advanced features that enhance the overall gaming experience, catering to Tournament enthusiasts worldwide. Our goal is to deliver an unparalleled Tournament gaming experience that captures the interest and enjoyment of players globally.
                                    </p>
          ...
          <div className="container-fluid">
            <div className="row align-items-center">
              ...
              <div className="col-lg-7 cus_col">
                <h2 className="title">
                  Tournament Game Development on Prime Platforms
                </h2>
                <div className="row">
        ...
        <section className="game_dev_comp_techstack">
          <div className="container">
            ...
            <div className="Admin-control-main-container">
              <h4>Online Tournament Game Features</h4>
              <div className="Admin-control-inner-container">
                <div className="a-card card-discover card1 col-md-3">
                  ...
                  <p className="card__description">
                    Play Tournament using your skills and win to earn real
                    cash. Use your Tournament expertise to earn real money
...
export default TournamentDevelopment;
