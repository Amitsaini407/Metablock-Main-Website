          ...
          <div className="row">
            <div className="cta-content ps-5 col-lg-6 d-flex align-items-center overflow-hidden">
              ...
              WE MAKE DREAMS <br> COME TO LIFE
                ...
                >
                  One of the top companies for developing Dragon Tiger games is MetaBlock. Our skilled group of Dragon Tiger game developers specializes in making games that are both easy to use and graphically appealing. We provide cutting-edge features that improve the overall play experience for fans of Dragon Tiger all over the world. Our mission is to provide players all around the world with an unmatched Dragon Tiger gaming experience that piques their curiosity and brings them delight.
                </p>
            ...
            <div className="col-lg-6 ps-0">
              <img
                ...
                src="./images/dragon-tiger-game-development-in-india.webp"
                alt='dragon-tiger-game-development-in-india'
              />
            </div>
          </div>
        </section>
          ...
          <div className="row">
            <div className="col-lg-6 ps-0">
              <img
                ...
                src="./images/dragon-tiger-game-development-in-india-2.webp"
                alt='Dragon Tiger Game Development Services'
              />
            </div>
            <div className="cta-content ps-5 col-lg-6 d-flex align-items-center overflow-hidden">
              <div style={{ paddingTop: "30px" }} className="container row gx-5 align-items-center">
                <h1 className="display-5 glow-text lh-1 mb-3 text-white fw-bold g-text">
                  Dragon Tiger Game Development Services
                </h1>
                {/* <h2 class="text-white display-1 lh-1 mb-4 ">
              WE MAKE DREAMS <br> COME TO LIFE
          </h2> */}
                ...
                <p className=" fw-normal text-white mb-4 ">
                  Our team of highly qualified game developers has a wealth of experience in making Dragon Tiger games that make you feel nostalgic and bring back happy childhood memories. With their skills, they can create games that perfectly represent the spirit of your history, guaranteeing a fun gaming experience. We have an established track record of success in the industry with the game Dragon Tiger. We have always demonstrated that we are the best Dragon Tiger game development company with our practical solutions.
                </p>
          ...
          <div className="container-fluid">
            <div className="row align-items-center">
              ...
              <div className="col-lg-7 cus_col">
                <h2 className="title">
                  Dragon Tiger Game Development on Prime Platforms
                </h2>
                <div className="row">
        ...
        <section className="game_dev_comp_techstack">
          <div className="container">
            ...
            <div className="Admin-control-main-container">
              <h4>Online Dragon Tiger Game Features</h4>
              <div className="Admin-control-inner-container">
                <div className="a-card card-discover card1 col-md-3">
                  ...
                  <p className="card__description">
                    Play Dragon Tiger using your skills and win to earn real
                    cash. Use your Dragon Tiger expertise to earn real money
