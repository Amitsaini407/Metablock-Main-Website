...
import GameAdminControl from "../GameAdminControl";
const RummyGameDevelopment = () => {
            ...
            <div className="cta-content ps-5 col-lg-6 d-flex align-items-center overflow-hidden">
              ...
              WE MAKE DREAMS <br> COME TO LIFE
                ...
                <h3 className=" mb-4 mt-4 txt-center-m">
                  Top Rated Rummy Game Developer
                </h3>
                <p
                  style={{ color: "white" }}
                  className=" fw-normal mb-4 txt-center-m"
                >
                  One of the top companies for developing Rummy games is MetaBlock. Our skilled group of Rummy game developers specializes in making games that are both easy to use and graphically appealing. We provide cutting-edge features that improve the overall play experience for fans of Rummy all over the world. Our mission is to provide players all around the world with an unmatched Rummy gaming experience that piques their curiosity and brings them delight.
                </p>
                        ...
                        <div className="row align-items-center justify-content-center">
                            <div className="col-lg-6 col-12">
                                <div className="banner_sec">
                                    <h1 className="title">
                                        <span className="bnr_clr_title">Rummy Game </span>{" "}
                                        <br /> Development
                                    </h1>
                                    <p className="contents">
                                        MetaBlock is a leading Rummy Game development company. Our experienced team of Rummy game developers specialized in creating visually captivating and user-friendly Rummy games. We incorporate advanced features that enhance the overall gaming experience, catering to Rummy enthusiasts worldwide. Our goal is to deliver an unparalleled Rummy gaming experience that captures the interest and enjoyment of players globally.
                                    </p>
          ...
          <div className="container-fluid">
            <div className="row align-items-center">
              ...
              <div className="col-lg-7 cus_col">
                <h2 className="title">
                  Rummy Game Development on Prime Platforms
                </h2>
                <div className="row">
        ...
        <section className="game_dev_comp_techstack">
          <div className="container">
            ...
            <div className="Admin-control-main-container">
              <h4>Online Rummy Game Features</h4>
              <div className="Admin-control-inner-container">
                <div className="a-card card-discover card1 col-md-3">
                  ...
                  <p className="card__description">
                    Play Rummy using your skills and win to earn real
                    cash. Use your Rummy expertise to earn real money
...
export default RummyGameDevelopment;
