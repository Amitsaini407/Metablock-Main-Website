  ...
  return (
    <div>
      <main className="blockchain_consulting_services">
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-6 col-12">
                <h1 className="ourservice-titles-new">DeFi Wallet Development <span className="cus_title"> </span><br /> <span className="grad_text"> Consulting </span> Services</h1>
                <h3 className="contents">With the help of our trustworthy blockchain consultants, you may take advantage of the best and most cutting-edge blockchain application to suit your needs as a business.
                </h3>
                <Link to="/contact-us">
        ...
        <section className="metaverse_game_services">
          <div className="container">
            ...
            <div className="row justify-content-center">
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="service_box pt-2">
        ...
        <section className="metaverse_dev_why">
          <div className="container">
            <div style={{ marginTop: '22vh' }} className="row align-items-center">
              <div className="col-lg-7 col-12 pr-lg-0">
                <h2 className="ourservice-titles-new grident-color-sub-title">Participate With Us</h2>
