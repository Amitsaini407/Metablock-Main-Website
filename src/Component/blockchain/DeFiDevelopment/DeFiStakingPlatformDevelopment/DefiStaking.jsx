      ...
      <main className="blockchain_consulting_services">
        <section className="blockchain_development_bnr_section">
          <div className="container">
            <div className="row defi-staking-development">
              <div className="col-lg-6 col-12 ">
                <h1 className="ourservice-title"> <span className="cus_title"> </span><br /> <span className="grad_text"> Defi Staking </span> Development</h1>
        ...
        <section className="blockchain_software">
          <div className="container">
            <div className="row d-flex align-items-center consulting-blockchain">
        ...
        <section className="metaverse_dev_why">
          <div className="container">
            <div className="row align-items-center blockchain-consult-company">
              ...
              <div className="col-lg-7 col-12 pr-lg-0">
                <h2 className="ourservice-titles-new grident-color-sub-title">Blockchain Consulting Company</h2>
        ...
        <section className="metaverse_game_services ">
          <div className="container">
            <h2 className="ourservice-titles-new grident-color-sub-title">Our Consultation on Blockchain</h2>
            <p className="contents" />
            <div className="row justify-content-center">
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="service_box">
                  ...
                  <p className="sub_contentts-new pt-2">We teach team members about the intricate workings of blockchain technology through workshops and seminars, along with pertinent applications, under the close supervision of advisors and educational resources.</p>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 col-12">
                <div className="service_box">
                  ...
                  <p className="sub_contentts-new pt-2">This is one of the key procedures we use to experience the study technique and understand the blockchain technology in use at your company now. We ascertain the processes involved in enabling your firm to advance.</p>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 col-12">
                <div className="service_box">
          ...
          <div className="container">
            <div className="row align-items-center">
              <div className="col-lg-5 col-12 pl-lg-0 pt-5 ">
                <img src="./images/Why-Opt-For-Us.webp" alt="Why Choose Us" title="Why Choose Us" style={{ borderRadius: "10px" }} className="" />
              </div>
              <div className="col-lg-7 col-12 pr-lg-0 defi-why-choose">
        ...
        <section className="metaverse_dev_why ">
          <div className="container">
            <div style={{ marginTop: "20vh" }} className="row align-items-center">
              <div className="col-lg-7 col-12 pr-lg-0 ">
                <h2 className="ourservice-titles-new grident-color-sub-title participate-defi">Participate With Us</h2>
