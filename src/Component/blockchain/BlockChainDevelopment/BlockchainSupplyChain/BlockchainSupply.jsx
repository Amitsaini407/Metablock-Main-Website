          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-6 col-12">
                <h1 className="grident-color-sub-title title-1">
                  {" "}
          ...
          <div className="container">
            <div className="row d-flex align-items-center">
              <div className="col-lg-7">
                <div className="bs_d_c_bg">
                  <h2 className="ourservice-titles-new grident-color-sub-title">
                    Blockchain Development Company in the Public and Private Sector
                  </h2>
                  <div>
              ...
              <div className="col-lg-5">
                <div className="video-wrapper blockchain-dao-facts">
        ...
        <section className="mid_section">
          <div className="container">
            <div className="section-heading text-center  d-flex justify-center align-center flex-column">
              <h3 className="grident-color-sub-title">
        ...
        <section className="alg_mac">
          <div className="container">
            <div className="section-heading text-center">
              <h3 className="grident-color-sub-title title-1">
          ...
          <div className="container">
            <div className="row align-items-center">
              <div className="col-lg-7 col-12 pr-lg-0">
                <h2 className="grident-color-sub-title title-1">
