  ...
  return (
    <div>
      <main id="white_label_crypto_main">
              ...
              <div className="col-lg-7 col-md-12 col-sm-12 col-12">
                <div>
                  <h1 className="title-10">
                    Pancakeswap  <b> Exchange</b> Development Company
                  </h1>
          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-4 col-12">
                <h2 className="title-10 grident-color-sub-title">Overview</h2>
          ...
          <div className="container">
            <div className="row justify-content-center align-items-center">
              <div className="col-lg-12">
                <h2 className="title-10 grident-color-sub-title">
        ...
        >
          <div className="container">
            <h2 className="title-10 grident-color-sub-title">Based on security measures, our solutions
            </h2>
            <p className="contents">
          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-lg-3 col-md-6 col-12">
                <div className="types_box">
                  <img width={'60x'}
                    src="./images/currency-exchange.webp"
            ...
            <div className="row">
              ...
              <div className="col-lg-3 col-md-6 col-12">
                <div className="types_box">
                  <img
                    width={'60px'}
                    src="./images/escrow-account.webp"
          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-5 col-12">
                <h2 className="title-10 grident-color-sub-title">Modules for White Label Crypto Exchanges</h2>
                <p className="contents">
              ...
              <div className="row">
                <div className="col-md-12 ">
                  <div className="nftgp_sectitle-10_wrap">
                    <h3 className="title-10 mt-0 mb-0 grident-color-sub-title">
                      Clone Script for Best Crypto Exchange
