          ...
          <div className="container-fluid">
            <div className="row row_just" style={{ marginTop: "10vh" }}>
              ...
              <div className="col-lg-6 col-12 nft-development-container-right">
                <img src="./images/NFT-Tokan-banner.webp" alt="Clone List" title="Clone List" className="img-fluid lazyload text-center"
              ...
              <div className="col-lg-12">
                <div className="row row_align">
                  <div className="col-lg-5">
                    <div className="pt-5">
                      <img style={{ width: "500px", borderRadius: "10px" }} src="./images/nft-nonfungible.webp" alt="Non-Fungible Token" title="Non-Fungible Token" />
          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-lg-4 col-md-6 text-center mb-3">
                <div className="service-wrap d-flex align-center justify-center flex-column">
                  <div className="service-icon">
                    <img src="./images/Blockchain.webp"  alt="Blockchain"/>
                  </div>
              ...
              <div className="col-lg-4 col-md-6 text-center mb-3">
                <div className="service-wrap d-flex align-center justify-center flex-column">
                  <div className="service-icon">
                    <img src="./images/ethereum.webp" alt="ethereum" />
                  </div>
              ...
              <div className="col-lg-4 col-md-6 text-center mb-3">
                <div className="service-wrap d-flex align-center justify-center flex-column">
                  <div className="service-icon">
                    <img src="./images/smart-contracts.webp" alt="smart-contracts" />
                  </div>
            ...
            <div className="row">
              ...
              <div className="col-lg-4 col-md-6 text-center mb-3">
                <div className="service-wrap d-flex align-center justify-center flex-column">
                  <div className="service-icon">
                    <img src="./images/collection.webp" alt="collection" />
                  </div>
              ...
              <div className="col-lg-4 col-md-6 text-center mb-3">
                <div className="service-wrap d-flex align-center justify-center flex-column">
                  <div className="service-icon">
                    <img src="./images/exchange.webp" alt="exchange" />
                  </div>
            ...
            <div className="row">
              ...
              <div className="col-lg-4 col-md-6 text-center mb-3">
                <div className="service-wrap d-flex align-center justify-center flex-column">
                  <div className="service-icon">
                    <img src="./images/digital.webp" alt="digital" />
                  </div>
              ...
              <div className="col-lg-4 col-md-6 text-center mb-3">
                <div className="service-wrap d-flex align-center justify-center flex-column">
                  <div className="service-icon">
                    <img src="./images/peer-to-peer.webp" alt="peer-to-peer" />
                  </div>
            ...
            <div className="row mt-5">
              <div className="col-lg-4 col-md-6 text-center mb-3">
                <div className="box">
                  ...
                  <div className="content" >
                    <img src="./images/hobby.webp" alt="Arts & Music" title="Arts & Music" />
              ...
              <div className="col-lg-4 col-md-6 text-center mb-3">
                <div className="box">
                  ...
                  <div className="content">
                    <img src="./images/sports.webp" alt="Games" title="Games" />
              ...
              <div className="col-lg-4 col-md-6 text-center mb-3">
                <div className="box">
                  ...
                  <div className="content">
                    <img src="./images/digital.webp" alt="Digital Content" title="Digital Content" />
              ...
              <div className="col-lg-4 col-md-6 text-center mb-3">
                <div className="box">
                  ...
                  <div className="content">
                    <img src="./images/web-domain.webp" alt="Domain Names" title="Domain Names" />
              ...
              <div className="col-lg-4 col-md-6 text-center mb-3">
                <div className="box">
                  ...
                  <div className="content">
                    <img src="./images/trend.webp" alt="Fashions" title="Fashions" />
              ...
              <div className="col-lg-4 col-md-6 text-center mb-3">
                <div className="box">
                  ...
                  <div className="content">
                    <img src="./images/assortment.webp" alt="Collectibles" title="Collectibles" />
              ...
              <div className="col-lg-4 col-md-6 text-center mb-3">
                <div className="box">
                  ...
                  <div className="content">
                    <img src="./images/assets.webp" alt="Real Estate" title="Real Estate" />
              ...
              <div className="col-lg-4 col-md-6 text-center mb-3">
                <div className="box">
                  ...
                  <div className="content">
                    <img src="./images/baseball.webp" alt="Fantasy Sports" title="Fantasy Sports" />
              ...
              <div className="col-lg-4 col-md-6 text-center mb-3">
                <div className="box">
                  ...
                  <div className="content">
                    <img src="./images/member-card.webp" alt="Subscription" title="Subscription" />
              ...
              <div className="col-lg-3 col-md-6 text-center mb-3">
                <div className="single-person">
                  <div className="person-image">
                    ...
                    <span className="icon">
                      <img src="./images/strong-motivated.webp" alt="strong-motivated" />
                    </span>
                  </div>
              ...
              <div className="col-lg-3 col-md-6 text-center mb-3">
                <div className="single-person">
                  <div className="person-image">
                    ...
                    <span className="icon">
                      <img src="./images/extremely-secure.webp" alt="extremely-secure" />
                    </span>
                  </div>
                  <div className="person-info">
              ...
              <div className="col-lg-3 col-md-6 text-center mb-3">
                <div className="single-person">
                  <div className="person-image">
                    ...
                    <span className="icon">
                      <img src="./images/Personalization-audience.webp" alt="Personalization-audience" />
                    </span>
                  </div>
                  <div className="person-info">
              ...
              <div className="col-lg-3 col-md-6 text-center mb-3">
                <div className="single-person">
                  <div className="person-image">
                    ...
                    <span className="icon">
                      <img src="./images/API-Conversion.webp" alt="API-Conversion" />
                    </span>
                  </div>
                  <div className="person-info">
              ...
              <div className="col-lg-3 col-md-6 text-center mb-3">
                <div className="single-person">
                  <div className="person-image">
                    ...
                    <span className="icon">
                      <img src="./images/Delivery-on-schedule.webp" alt="Delivery-on-schedule" />
                    </span>
                  </div>
                  <div className="person-info">
              ...
              <div className="col-lg-3 col-md-6 text-center mb-3">
                <div className="single-person">
                  <div className="person-image">
                    ...
                    <span className="icon">
                      <img src="./images/Manifesto.webp" alt="Manifesto" />
                    </span>
                  </div>
                  <div className="person-info">
              ...
              <div className="col-lg-3 col-md-6 text-center mb-3">
                <div className="single-person">
                  <div className="person-image">
                    ...
                    <span className="icon">
                      <img src="./images/Dispersed.webp" alt="Dispersed" />
                    </span>
                  </div>
                  <div className="person-info">
