...
import './NFTLendingPlatform.css'
import AutoPlaylending from "./NftLendingslider";
const NFTLendingPlatform = () => {
  return (
    <div>
      ...
      <main id="nft_marketplace_main">
            ...
            <div className="row align-items-center justify-content-center banner_img_col">
              <div className="col-lg-6 col-12">
                <div className="banner_sec">
                  <h1 className="grident-color-sub-title ourservice-titles-new"><span className="cus_title">NFT Lending </span> <br /> Platform Development</h1>
              ...
              <div className="col-lg-6 col-12 nft-development-container-right">
                <img src="./images/nft-lending-platform-banner.webp" alt="Clone List" title="Clone List" className="img-fluid lazyload text-center"
        ...
        <section className="nft_marketplace_usecase">
          <div className="container">
            <h2 className="grident-color-sub-title ourservice-titles-new">NFT Use Cases</h2>
