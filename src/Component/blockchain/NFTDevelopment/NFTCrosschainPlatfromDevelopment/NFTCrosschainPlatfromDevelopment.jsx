            ...
            <div className="row align-items-center justify-content-center banner_img_col">
              <div className="col-lg-6 col-12">
                <div className="banner_sec">
                  <h1 className="ourservice-title"><span className="cus_title">NFT Crosschain Platfrom DEVELOPMENT  </span> <br /></h1>
              ...
              <div className="col-lg-6 col-12 nft-development-container-right">
                <img src="./images/Nft-crosschain-development-banner.webp" alt="Clone List" title="Clone List" className="img-fluid lazyload text-center"
