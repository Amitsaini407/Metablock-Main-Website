...
import './BinanaceSmartChainBEP20TokenDevelopment.css'
import { Link } from "react-router-dom";


const BinanaceSmartChainBEP20TokenDevelopment = () => {
  return (
    <div>
      &lt;&gt;
      <main id="token_dev_main">
            ...
            <div className="row align-items-center justify-content-center">
              ...
              <div className="col-lg-6 col-12 order-1 order-lg-2">
                <div className="banner_cont_sec">
                  <h1 className="ourservice-titles-new grident-color-sub-title"><span className="bnr_bld_title">Binanace Intelligent
                  </span> <br /> Chain Tokan Creation </h1>
            ...
            <div className="row justify-content-center align-items-center">
              <div className="col-lg-7 col-12">
                <div className="techstack_sli">
                  <h2 className="ourservice-titles-new grident-color-sub-title">Crypto Token Development</h2>
              ...
              <div className="col-lg-5 col-12">
                <img src="./images/fungiable-tokan-development.webp" alt="Crypto Token Development Company" title="Crypto Token Development Company" />
              </div>
            </div>
          </div>
        </section>
        <section className="token_dev_services">
          <div className="container back_color">
            <h2 className="ourservice-titles-new grident-color-sub-title">Our Services for Token Development</h2>
            <div className="row justify-content-center align-items-center">
              <div className="col-lg-4 col-md-6 col-12 cus_col">
                <div className="service_box">
                  <img width={'80px'} src="./images/ethereum.webp" alt="Ethereum Token Development" title="Ethereum Token Development" />
              ...
              <div className="col-lg-4 col-md-6 col-12 cus_col">
                <div className="service_box">
                  <img width={'80px'} src="./images/coin.webp" alt="Tron Token Development" title="Tron Token Development" />
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="service_box">
                  <img width={'80px'} src="./images/solana.webp" alt="Solana Token Development" title="Solana Token Development" />
              ...
              <div className="col-lg-4 col-md-6 col-12 cus_col">
                <div className="service_box">
                  <img width={'80px'} src="./images/polygon.webp" alt="Polygon Token Development" title="Polygon Token Development" />
              ...
              <div className="col-lg-4 col-md-6 col-12 cus_col">
                <div className="service_box">
                  <img width={'80px'} src="./images/virtual-currency.webp" alt="Asset Token Development" title="Asset Token Development" />
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="service_box">
                  <img width={'80px'} src="./images/digital-token.webp" alt="Metaverse Token Development" title="Metaverse Token Development" />
              ...
              <div className="col-lg-4 col-md-6 col-12 cus_col">
                <div className="service_box">
                  <img width={'80px'} src="./images/smart-contracts.webp" alt="Smart Contract Development" title="Smart Contract Development" />
              ...
              <div className="col-lg-4 col-md-6 col-12 cus_col">
                <div className="service_box">
                  <img width={'80px'} src="./images/tokens.webp" alt="Token Generator Platform Development" title="Token Generator Platform Development" />
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="service_box">
                  <img width={'80px'} src="./images/coin.webp" alt="Altcoin Token Development" title="Altcoin Token Development" />
        ...
        <section className="token_dev_odd_serv">
          <div className="container">
            <h2 className="ourservice-titles-new grident-color-sub-title">Our Supplementary Services</h2>
            <div className="odd_serv_cardsec">
              <div className="card">
                <div className="imgBx" data-taxt="Design">
                  <img src="./images/retail.webp" alt="Liquidity-Provision-and-Market-Making" title="Liquidity Provision and Market Making" />
                </div>
              ...
              <div className="card">
                <div className="imgBx" data-taxt="Code">
                  <img src="./images/wallet.webp" alt="Token-Wallet-Development" title="Token Wallet Development" />
                </div>
                <div className="content_sec">
                  <div>
              ...
              <div className="card">
                <div className="imgBx" data-taxt="startup">
                  <img src="./images/contracts.webp" alt="White-Paper-Creation" title="White Paper Creation" />
                </div>
                <div className="content_sec">
                  <div>
              ...
              <div className="card">
                <div className="imgBx" data-taxt="Money">
                  <img src="./images/token.webp" alt="ICO-Development" title="ICO Development" />
                </div>
                <div className="content_sec">
                  <div>
        ...
        <section className="token_dev_models">
          <div className="container">
            <h2 className="ourservice-titles-new grident-color-sub-title">Different Models for Token Development</h2>
            <div className="row justify-content-center">
              <div className="col-lg-4 col-md-6 col-12">
                <div className="model_box">
                  <h3 className="different-modal-boxes-headings ">Tokens for Security</h3>
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="model_box">
                  <h3 className="different-modal-boxes-headings">Tokens of Equity</h3>
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="model_box">
                  <h3 className="different-modal-boxes-headings">Tokens for the Metaverse</h3>
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="model_box">
                  <h3 className="different-modal-boxes-headings">DeFi tokens</h3>
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="model_box">
                  <h3 className="different-modal-boxes-headings">Utility Tokens</h3>
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="model_box">
                  <h3 className="different-modal-boxes-headings">Non-Fungible Tokens</h3>
        ...
        <section className="token_dev_benefits">
          <div className="container">
            <h2 className="ourservice-titles-new grident-color-sub-title">Introducing Your Own Crypto Token Has Its Advantages</h2>
            <div className="row align-items-center">
              <div className="col-lg-5 col-12 order-2 order-lg-1 benefits_img_mblsec">
                <img src="./images/YourOwnCrypto-Token.webp" style={{ borderRadius: '13px' }} alt='Benefits of Introducing Your Own Crypto Token' title="Benefits of Introducing Your Own Crypto Token" />
              </div>
              <div className="col-lg-7 col-12 order-1 order-lg-2">
                <div className="benefits_list_sec">
                  <div className="benefits_list">
                    <div className="contents_sec d-flex justify-center align-center flex-column">
                      <img width={'60px'} src="./images/fundraising.webp" alt="Benefits List Icon" title="Benefits List Icon" className="img-fluid" />
                  ...
                  <div className="benefits_list">
                    <div className="contents_sec d-flex justify-center align-center flex-column">
                      <img width={'60px'} src="./images/sale.webp" alt="Benefits List Icon" title="Benefits List Icon" className="img-fluid" />
                  ...
                  <div className="benefits_list">
                    <div className="contents_sec d-flex justify-center align-center flex-column">
                      <img width={'60px'} src="./images/global-connection.webp" alt="Benefits List Icon" title="Benefits List Icon" className="img-fluid" />
                  ...
                  <div className="benefits_list">
                    <div className="contents_sec d-flex justify-center align-center flex-column">
                      <img width={'60px'} src="./images/dollar.webp" alt="Benefits List Icon" title="Benefits List Icon" className="img-fluid" />
                  ...
                  <div className="benefits_list">
                    <div className="contents_sec d-flex justify-center align-center flex-column">
                      <img width={'60px'} src="./images/events.webp" alt="Benefits List Icon" title="Benefits List Icon" className="img-fluid" />
                  ...
                  <div className="benefits_list">
                    <div className="contents_sec d-flex justify-center align-center flex-column">
                      <img width={'60px'} src="./images/monetary.webp" alt="Benefits List Icon" title="Benefits List Icon" className="img-fluid" />
        ...
        <section className="token_dev_process">
          <div className="container">
            <h2 className="ourservice-titles-new grident-color-sub-title">How to Develop Your Own Cryptocurrency Token</h2>
            <div className="row justify-content-center">
              <div className="col-lg-4 col-md-6 col-12">
              ...
              <div className="col-lg-3 col-md-6 col-12">
                <div className="process_box">
                  ...
                  <p className="sub_contents"> tokens are blockchain-based smart contracts & choosing  appropriate blockchain framework is essential for token development.</p>
                </div>
              </div>
              <div className="col-lg-3 col-md-6 col-12">
                <div className="process_box">
        ...
        <section className="token_dev_techstack">
          <div className="container">
            <h2 className="ourservice-titles-new grident-color-sub-title">Our Technology Stack</h2>
        ...
        <section className="token_dev_features">
          <div className="container">
            <h2 className="ourservice-titles-new grident-color-sub-title">Unique Elements in the Creation of Crypto Tokens</h2>
            <div className="row justify-content-center align-items-center" id="feature_bg_color">
              <div className="col-lg-4 col-md-6 col-12">
                <div className="feature_box">
                  <div className="head_sec">
                    <img width={'45px'} src="./images/ownership.webp" alt="Access to Ownership" title="Access to Ownership" />
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="feature_box">
                  <div className="head_sec">
                    <img width={'45px'} src="./images/3d.webp" alt="Mintable" title="Mintable" />
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="feature_box">
                  <div className="head_sec">
                    <img width={'45px'} src="./images/procrastination.webp" alt="Token Pause" title="Token Pause" />
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="feature_box">
                  <div className="head_sec">
                    <img width={'45px'} src="./images/concealer.webp" alt="Capped" title="Capped" />
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="feature_box">
                  <div className="head_sec">
                    <img width={'45px'} src="./images/tokens.webp" alt="Burnable token" title="Burnable token" />
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="feature_box">
                  <div className="head_sec">
                    <img width={'45px'} src="./images/clipboard.webp" alt="Detailed" title="Detailed" />
        ...
        <div className="container">
          <div className="row" id="token_dev_join_card">
            <div className="col-xl-7">
              <div className="title">Take the Step to Realize Your Complete Potential</div>
              <div className="token_dev_btn_sec">
                <button data-toggle="modal" data-target="#popup_form_modal" className="btn token_dev_btn"><span>Get Your Free Demo Right Now.</span></button>
              </div>
            </div>
        ...
        <section className="token_dev_platforms">
          <div className="container">
            <h2 className="ourservice-titles-new grident-color-sub-title">Several Platforms We Are Skilled in</h2>
            <div className="row align-items-center">
              <div className="col-lg-2 col-md-4 col-sm-4 col-6">
                <div className="platform_list">
                  <img width={'50px'} src="./images/ethereum.webp" alt="ethereum" title="ethereum" />
                  <div className="sub_title">Ethereum</div>
                </div>
              </div>
              <div className="col-lg-2 col-md-4 col-sm-4 col-6">
                <div className="platform_list">
                  <img width={'50px'} src="./images/diagnosis.webp" alt="Eos" title="Eos" />
                  <div className="sub_title">Eos</div>
                </div>
              </div>
              <div className="col-lg-2 col-md-4 col-sm-4 col-6">
                <div className="platform_list">
                  <img width={'50px'} src="./images/tezos.webp" alt="Tezos" title="Tezos" />
                  <div className="sub_title">Tezos</div>
                </div>
              </div>
              <div className="col-lg-2 col-md-4 col-sm-4 col-6">
                <div className="platform_list">
                  <img width={'50px'} src="./images/blockchain.webp" alt="Hyperledger" title="Hyperledger" />
                  <div className="sub_title">Hyperledger</div>
                </div>
              </div>
              <div className="col-lg-2 col-md-4 col-sm-4 col-6">
                <div className="platform_list">
                  <img width={'50px'} src="./images/stellar-coin.webp" alt="Stellar" title="Stellar" />
                  <div className="sub_title">Stellar</div>
                </div>
              </div>
              <div className="col-lg-2 col-md-4 col-sm-4 col-6">
                <div className="platform_list">
                  <img width={'50px'} src="./images/polygon.webp" alt="Matic" title="Matic" />
                  <div className="sub_title">Matic</div>
                </div>
              </div>
              <div className="col-lg-2 col-md-4 col-sm-4 col-6">
                <div className="platform_list">
                  <img width={'50px'} src="./images/fantom.webp" alt="Fantom" title="Fantom" />
                  <div className="sub_title">Fantom</div>
                </div>
              </div>
              <div className="col-lg-2 col-md-4 col-sm-4 col-6">
                <div className="platform_list">
                  <img width={'50px'} src="./images/ripple.webp" alt="Ripple" title="Ripple" />
                  <div className="sub_title">Ripple</div>
                </div>
              </div>
              <div className="col-lg-2 col-md-4 col-sm-4 col-6">
                <div className="platform_list">
                  <img width={'50px'} src="./images/solana.webp" alt="Solana" title="Solana" />
                  <div className="sub_title">Solana</div>
                </div>
              </div>
              <div className="col-lg-2 col-md-4 col-sm-4 col-6">
                <div className="platform_list">
                  <img width={'50px'} src="./images/polygon.webp" alt="Polygon" title="Polygon" />
                  <div className="sub_title">Polygon</div>
                </div>
              </div>
              <div className="col-lg-2 col-md-4 col-sm-4 col-6">
                <div className="platform_list">
                  <img width={'50px'} src="./images/binance.webp" alt="Binance smart chain" title="Binance smart chain" />
                  <div className="sub_title">Binance smart chain</div>
                </div>
              </div>
              <div className="col-lg-2 col-md-4 col-sm-4 col-6">
                <div className="platform_list">
                  <img width={'50px'} src="./images/economic.webp" alt="Huabi ECO Chain" title="Huabi ECO Chain" />
        ...
        <section className="token_dev_sectors">
          <div className="container">
            <h2 className="ourservice-titles-new grident-color-sub-title">Traditional Sectors Are Being Shaped by Crypto Tokens</h2>
            <p className="contents">Enhanced Sectors Utilizing Intelligent Coins</p>
            <div className="row justify-content-center">
              <div className="col-lg-4 col-md-6 col-12">
                <div className="sector_box">
                  <img width={'50px'} src="./images/finance.webp" alt="Finance" title="Finance" />
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="sector_box">
                  <img width={'50px'} src="./images/real-estate.webp" alt="Real Estate" title="Real Estate" />
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="sector_box">
                  <img width={'50px'} src="./images/game-controller.webp" alt="Gaming" title="Gaming" />
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="sector_box">
                  <img width={'50px'} src="./images/blockchain.webp" alt="Supply Chain" title="Supply Chain" />
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="sector_box">
                  <img width={'50px'} src="./images/balance.webp" alt="Energy and Sustainability" title="Energy and Sustainability" />
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="sector_box">
                  <img width={'50px'} src="./images/healthcare.webp" alt="Healthcare" title="Healthcare" />
        ...
        <section className="token_dev_whymetablock">
          <div className="container">
            <div className="row  justify-center align-items-center">
              <div className="col-lg-5 col-12 order-2 order-lg-1">
                <img src="./images/Cryptocurrency-Token-Development-Services-1.webp" alt="Why Choose MetaBlock For Cryptocurrency Token Development Services?" title="Why Choose MetaBlock For Cryptocurrency Token Development Services?" className="Cryptocurrency-Token-Development-Services-1" />
              </div>
              <div className="col-lg-7 col-12 order-1 order-lg-2">
                <div>
                  <h2 className="ourservice-titles-new grident-color-sub-title">Why Opt for Cryptocurrency Token Development Services From MetaBlock?</h2>
...
export default BinanaceSmartChainBEP20TokenDevelopment
