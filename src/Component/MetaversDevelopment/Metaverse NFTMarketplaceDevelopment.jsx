          ...
          <div className="container-fluid cus_container">
            <div className="row align-items-center justify-content-center">
              <div className="col-lg-7 col-12 p-0 nft_tops ">
                <img style={{ width: "540px", borderRadius: "10px" }} src="./SGimage/6646303.webp" alt="Metaverse-Game-Development-Company" title="Metaverse Game Development Company" className="banner_img img-fluid" />
              </div>
                ...
                <div className="banner_contsec">
                  ...
                  <div className="HddrBtns banner_btn_sec">
                    <button toggle="modal" target="#popup_form_modal" className="btn BtnPrimry TlkBtn banner_btn">
                      <Link to="/contact-us"> <span  loading="eager" className="img-fluid lazyload mr-2 lazyload" >Get A Live Quote</span></Link>
                      <span  loading="eager" className="img-fluid lazyload mr-2" >Get A Live Quote</span>
                    </button>
                  </div>
                </div>
              </div>
          ...
          <div className="container">
            <div className="row align-items-center">
              ...
              <div className="col-lg-7 col-12 nft_top">
                <img src="./SGimage/5360615.webp" alt="Metaverse Game Development" title="Metaverse Game Development" className="img-fluid lazyload metav_game_dev_img" style={{ borderRadius: "10px" }} />
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-12 col-12 nft_top">
                <img src="./SGimage/6626132.webp" alt="Metaverse Game Development" title="Metaverse Game Development" className="img-fluid lazyload" />
              </div>
        ...
        <section className="metaverse_game_whatsec">
          <div className="container">
            <div className="row align-items-center what-is-metaverse-nft-container">
              <div className="col-lg-7 col-12 nft_top">
                <img src="./SGimage/6626132.webp" alt="Metaverse Game Development" title="Metaverse Game Development" className="img-fluid lazyload metav_game_dev_img What-is-metaverse-NFT-img" style={{ borderRadius: "10px" }} />
              </div>
              <div className="col-lg-5 col-12">
            ...
            <div className="row justify-content-center">
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="benefits_box cp_center">
                  <div className="img_sec">
                    <img style={{ width: '80px', height: 'fit-content', borderRadius: '50px' }} src="./SGimage/3828822.webp" alt="Opportunities for the economy" title="Opportunities for the economy" className="" />
                  </div>
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="benefits_box clippath2">
                  <div className="img_sec">
                    <img style={{ width: '80px', height: 'fit-content', borderRadius: '50px' }} src="./SGimage/6213049.webp" alt="Opportunities for the economy" title="Opportunities for the economy" className="" />
                  </div>
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="benefits_box clippath1">
                  <div className="img_sec">
                    <img style={{ width: '80px', height: 'fit-content', borderRadius: '50px' }} src="./SGimage/6681650-min.webp" alt="Opportunities for the economy" title="Opportunities for the economy" className="" />
                  </div>
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="benefits_box cp_center">
                  <div className="img_sec">
                    <img style={{ width: '80px', height: 'fit-content', borderRadius: '50px' }} src="./SGimage/6594175-min.webp" alt="Opportunities for the economy" title="Opportunities for the economy" className="" />
                  </div>
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="benefits_box clippath2">
                  <div className="img_sec">
                    <img style={{ width: '80px', height: 'fit-content', borderRadius: '50px' }} src="./SGimage/52124-min.webp" alt="Opportunities for the economy" title="Opportunities for the economy" className="" />
                  </div>
