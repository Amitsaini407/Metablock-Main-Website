            ...
            <main id="metaverse_event_platform_main">
                        ...
                        <div className="row align-items-center justify-content-center banner_img_col ">
                            <div className="col-lg-12 col-12">
                                <div className="banner_sec ">
                                    <h1 className="grident-color-sub-title title">Metaverse Social Platform Development</h1>
                            ...
                            <div className="container">
                                <div className="content_sec">
                                    <div className=" title_sec metaverse-social-develoment">
                                        <h1 className=" title main-titile grident-color-sub-title">Metaverse Social Platform Development</h1>
                                    </div>
                                    <p className="contents">
                                        Embrace the metaverse's power and transform your events with our Metaverse Social Media Platform Development Service.
                                    </p>
                                    <div className="HddrBtns banner_btn_sec">
                                        <a data-toggle="modal" data-target="#popup_form_modal" className="btn BtnPrimry TlkBtn banner_btn" target="_blank">
                                            <Link to="/contact-us">    <span className="img-fluid lazyload mr-2" >Get A Live Quote</span></Link>
                        ...
                        <div className="row justify-content-center align-items-center">
                            <div className="col-lg-12 col-12">
                                ...
                                <div className="virtual_content_sec">
                                    <h2 className="grident-color-sub-title ourservice-titles-new">Metaverse Virtual Event</h2>
                ...
                <section className="metaverse_event_platform_solut">
                    <div className="container-fluid">
                        <h2 className="grident-color-sub-title ourservice-titles-new">Our Metaverse Virtual Event Solutions</h2>
                ...
                <section className="metaverse_event_platform_features">
                    <div className="container">
                        <h2 className="grident-color-sub-title ourservice-titles-new">Characteristics Of The Metaverse Social Network</h2>
                ...
                <section className="metaverse_event_platform_benefits">
                    <div className="container">
                        <h2 className="grident-color-sub-title ourservice-titles-new">Benefits Of Metaverse Virtual Event Platform</h2>
                        ...
                        <div className="row justify-content-center align-items-center">
                            ...
                            <div className="col-lg-6 col-12">
                                <div className="img_sec">
                                    <img src="./SGimage/Close up.webp" alt="Benefits Of Metaverse Virtual Event Platform" title="Benefits Of Metaverse Virtual Event Platform" style={{ borderRadius: "10px" }} />
                                </div>
                            </div>
                            <div className="col-lg-3 col-12">
                                <div className="benefits_box_sec">
                    ...
                    <div className="container">
                        <div className="row justify-content-center">
                            <div className="col-lg-9 col-12">
                                <h2 className="grident-color-sub-title title">Why Should the Event Industry Use Metaverse?
                                </h2>
                                    ...
                                    <div className="owl-carousel owl-theme">
                                        <div className="window">
                                            <div className="why_box">
                                                <div className="grident-color-sub-title sub_title">Improved Intimacy
                                                </div>
                                        ...
                                        <div className="window">
                                            <div className="why_box">
                                                <div className="grident-color-sub-title sub_title">Increased Availability
                                                </div>
                                        ...
                                        <div className="window">
                                            <div className="why_box">
                                                <div className="grident-color-sub-title sub_title">Adaptable Avatars
                                                </div>
                                        ...
                                        <div className="window">
                                            <div className="why_box">
                                                <div className="grident-color-sub-title sub_title">Geographical Audio
                                                </div>
                                        ...
                                        <div className="window">
                                            <div className="why_box">
                                                <div className="grident-color-sub-title sub_title">Engaging Spaces
                                                </div>
                                        ...
                                        <div className="window">
                                            <div className="why_box">
                                                <div className="grident-color-sub-title sub_title">Recording and Live Streaming
                                                </div>
                                        ...
                                        <div className="window">
                                            <div className="why_box">
                                                <div className="grident-color-sub-title sub_title">Data Analytics hello</div>
                                        ...
                                        <div className="window">
                                            <div className="why_box">
                                                <div className="grident-color-sub-title sub_title">Blockchain Consolidation
                                                </div>
                                        ...
                                        <div className="window">
                                            <div className="why_box">
                                                <div className="grident-color-sub-title sub_title">Components of Gamification
                                                </div>
                                        ...
                                        <div className="window">
                                            <div className="why_box">
                                                <div className="grident-color-sub-title sub_title">Longer Duration of Events
                                                </div>
                    ...
                    <div className="container">
                        <div className="row justify-content-center align-items-center">
                            <div className="col-lg-7 col-12">
                                <div>
                                    <h2 className="grident-color-sub-title title-10">Why Use MetaBlock To Develop A Virtual Event Platform For The Metaverse?
                                    </h2>
