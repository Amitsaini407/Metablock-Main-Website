...
export default class NFTPorfolio extends Component {
            ...
            <div className="RelatedPortfolioSlider-main-div">
                <div className="RelatedPortfolioSlider-div">
                    <Slider {...settings}>
                        <div>
                            <div className="PrjctExmplsImg">
                                <img
                                    ...
                                    src="./images/Websitesliderportfolio-1.webp"
                                    alt="Game Portfolio1"
                        ...
                        <div>
                            <div className="PrjctExmplsImg">
                                <img data-toggle="modal" data-target="#portfolio_modal"
                                    src="./images/Websitesliderportfolio-2.webp"
                        ...
                        <div>
                            <div className="PrjctExmplsImg">
                                <img data-toggle="modal" data-target="#portfolio_modal" src="./images/Websitesliderportfolio-3.webp"
                        ...
                        <div>
                            <div className="PrjctExmplsImg">
                                <img data-toggle="modal" data-target="#portfolio_modal" src="./images/Websitesliderportfolio-4.webp"
                        ...
                        <div>
                            <div className="PrjctExmplsImg">
                                <img data-toggle="modal" data-target="#portfolio_modal" src="./images/Websitesliderportfolio-5.webp"
