...
export default class DefiPorfolio extends Component {
            ...
            <div className="RelatedPortfolioSlider-main-div">
                <div className="RelatedPortfolioSlider-div">
                    <Slider {...settings}>
                        <div>
                            <div className="PrjctExmplsImg">
                                <img
                                    ...
                                    src="./images/DefisliderPortfolio-1.webp"
                                    alt="Game Portfolio1"
                        ...
                        <div>
                            <div className="PrjctExmplsImg">
                                <img data-toggle="modal" data-target="#portfolio_modal" src="./images/DefisliderPortfolio-2.webp"
                        ...
                        <div>
                            <div className="PrjctExmplsImg">
                                <img data-toggle="modal" data-target="#portfolio_modal" src="./images/DefisliderPortfolio-3.webp"
                        ...
                        <div>
                            <div className="PrjctExmplsImg">
                                <img data-toggle="modal" data-target="#portfolio_modal" src="./images/DefisliderPortfolio-4.webp"
                        ...
                        <div>
                            <div className="PrjctExmplsImg">
                                <img data-toggle="modal" data-target="#portfolio_modal" src="./images/DefisliderPortfolio-5.webp"
