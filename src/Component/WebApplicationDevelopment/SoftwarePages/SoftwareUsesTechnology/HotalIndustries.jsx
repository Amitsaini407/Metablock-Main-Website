    ...
    <div className="m-0">
      <div className="dashboard-main-box">
        ...
        <div className="dashboard-container">
          <div className="dashboard-container-box dashboard-boxes">
            <div className="key-feature-heading">
              <img src="./images/time-management (1).webp" alt="Reservation Management" />
          ...
          <div className="dashboard-container-box dashboard-boxes">
            <div className="key-feature-heading">
              <img src="./images/processing.webp" alt="Front Desk Operations" />
          ...
          <div className="dashboard-container-box dashboard-boxes">
            <div className="key-feature-heading">
              <img src="./images/networking.webp" alt="Housekeeping Coordination" />
          ...
          <div className="dashboard-container-box dashboard-boxes">
            <div className="key-feature-heading">
              <img src="./images/invoice (1).webp" alt="Billing and Invoicing" />
        ...
        <div className="dashboard-container">
          <div className="dashboard-container-box dashboard-boxes">
            <div className="key-feature-heading">
              <img src="./images/management (1).webp" alt="Guest Relationship Management" />
          ...
          <div className="dashboard-container-box dashboard-boxes">
            <div className="key-feature-heading">
              <img src="./images/report.webp" alt="Reporting and Analytics" />
          ...
          <div className="dashboard-container-box dashboard-boxes">
            <div className="key-feature-heading">
              <img src="./images/monitoring.webp" alt="Maintenance Tracking" />
...
export default HotalIndustries;
