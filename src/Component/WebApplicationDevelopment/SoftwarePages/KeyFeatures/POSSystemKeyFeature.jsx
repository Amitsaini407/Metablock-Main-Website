    ...
    <div style={{ marginBottom: "50px " }}>
      <div className="dashboard-main-box">
        ...
        <div className="dashboard-container">
          <div className="dashboard-container-box dashboard-boxes">
            <div className="key-feature-heading">
              <img src="./images/effectiveness.webp" alt="Sales Processing" />
          ...
          <div className="dashboard-container-box dashboard-boxes">
            <div className="key-feature-heading">
              <img src="./images/supply-chain.webp" alt="Inventory Management" />
          ...
          <div className="dashboard-container-box dashboard-boxes">
            <div className="key-feature-heading">
              <img src="./images/barcode-scanner.webp" alt="Barcode Scanning" />
          ...
          <div className="dashboard-container-box dashboard-boxes">
            <div className="key-feature-heading">
              <img src="./images/employee.webp" alt="Employee Management" />
        ...
        <div className="dashboard-container">
          <div className="dashboard-container-box dashboard-boxes">
            <div className="key-feature-heading">
              <img src="./images/data-analysis.webp" alt="Reporting and Analytics" />
          ...
          <div className="dashboard-container-box dashboard-boxes">
            <div className="key-feature-heading">
              <img src="./images/support.webp" alt="Multi-Store Support" />
          ...
          <div className="dashboard-container-box dashboard-boxes">
            <div className="key-feature-heading">
              <img src="./images/online-payment.webp" alt="Mobile POS" />
          ...
          <div className="dashboard-container-box dashboard-boxes">
            <div className="key-feature-heading">
              <img src="./images/customixw.webp" alt="Customizable Menus and Layouts" />
              ...
              <p>
                ...
                requirements and optimize user experience.
              </p>
            </div>
          </div>
        </div>
...
export default POSSystemKeyFeature;
