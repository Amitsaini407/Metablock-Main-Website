        ...
        <div className="m-0">
            <div className="dashboard-main-box">
                ...
                <div className="dashboard-container">
                    <div className="dashboard-container-box dashboard-boxes">
                        <div className="key-feature-heading">
                            <img src="./images/shopping.webp" alt="E-commerce" />
                    ...
                    <div className="dashboard-container-box dashboard-boxes">
                        <div className="key-feature-heading">
                            <img src="./images/joystick.webp" alt="Gaming" />
                    ...
                    <div className="dashboard-container-box dashboard-boxes">
                        <div className="key-feature-heading">
                            <img src="./images/freelance-work.webp" alt="Freelancing" />
...
export default ChattingIndustries
