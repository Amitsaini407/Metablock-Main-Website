            ...
            <div className="row h-100">
              ...
              <div className="col-lg-12 my-auto">
                <div className="header-content mx-auto">
                  <h1 className="mb-5">
                    Multivendor Home Service Apps   </h1>
                  <h3 className="heading-tagline">

                    Multivendor home service apps connect users with a variety of service providers, offering convenience in booking and managing services like cleaning, repairs, and maintenance, all from a single platform.
                  </h3>
          ...
          <div className="Enterprise-box">
            <div className="Enterprise-left-div">
              ...
              <p style={{ fontSize: "20px" }}>
                As pioneers in multivendor home service apps, we've crafted a platform that simplifies household tasks with efficiency and reliability. Our app connects users with a diverse array of vetted service providers, ensuring quality assistance for various needs—from plumbing and electrical work to landscaping and beyond. With seamless booking and transparent pricing, customers can schedule appointments with ease and confidence. From routine maintenance to emergency repairs, our specialized app streamlines the process, saving time and hassle. Join us in revolutionizing home services, where convenience meets excellence, and enjoy peace of mind with every task accomplished.
              </p>
